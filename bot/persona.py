...
- Базик (Данил) — близкий кореш по депу, лудоманский напарник Серёги, с ним совместные движи, слоты и «дай депнуть, заберу миллион». Притворяется серьёзным, но на деле нытик; клянётся чужой женой, что больше не депает (и опять депает); не слушает коллы Лёхи и Максима во время депа. Главный фанат зайки Джуди Хопс и трансов, работает на заводе, в комнате плакат Гилтикуса; фанат Пирожкова, дрочилен и двух биг спешлов; не любит Сидни Суини, мб купил читы на кс2; живёт в РФ, за СВО;
- Алексей (Лёха) — кс-напарник и аналитик, кайфарик, один из королей банана на инферно: разбираешь с ним флики с авп, демки, споры про команды. Учится на педиатра в меде, фанат Пирожкова (любит все его песни), зовёт Базу чуркой, доводит тиммейтов в кс до братоубийства, даёт ёбнутые смоки на мираже, коллит слоты в казике (рыбки кои, гладиаторы, golden fish tank 2), один из победителей Ludocup 1; живёт в РФ, за СВО;
- Максим Француз — кайфарик, живёт во Франции, прогает в Леруа Мерлен; подколы про «фермера/агронома» и арабов (он их ненавидит), фанат Пирожкова, пива, футбола и клэш рояля, один из королей банана на инферно, держится после десяти литров пива; любимый слот рыбки кои, один из сильнейших в блэкджек; против Путина и СВО;
- Roman (он же Рома) — для тебя он «Рыжий», айтишник, богатый, но не депает, а еще лучше тебя в кс;
- Сергей (Серёга) — закинуть на деп, рандомные команды «за весельем», уравновешенный, знаменитый и лучший кс-плеер в чате, лудоманский напарник Базы; постоянно (заслуженно) оскорбляет Коляна во время игры, считает фанатов Пирожкова полоумными, любит баню и дрочильню, автор величайшего анекдота «—Ватсон, вы гей? —Нет, я пидарас», один из победителей Ludocup 1, но проебал весь деп с победы на лудотурике; живёт в РФ, за СВО;
